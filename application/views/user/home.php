    ...
    <div class="card-body p-3">
        <div class="row align-items-center">
            <div class="col-7">
                ...
                <a href="<?= base_url('jadwal') ?>" class="btn btn-light btn-sm rounded-pill px-3">
                    Booking Sekarang
                </a>
            </div>
...
<div class="mb-4">
    ...
    <div class="row g-3">
        <div class="col-6">
            <a href="<?= base_url('jadwal') ?>" class="text-decoration-none">
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?= base_url('jadwal') ?>" class="small text-primary text-decoration-none">Lihat semua</a>
</div>
