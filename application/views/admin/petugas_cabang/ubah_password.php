<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">
            <a href="<?= base_url('petugas_cabang') ?>" class="text-muted fw-light">Daftar Petugas Cabang</a> /
        </span>
        Ubah Password
    </h4>
    <div class="row">
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Ubah Password Petugas <?= $petugas['nama'] ?></h5>
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form method="post" action="<?= base_url('petugas_cabang/password/' . $petugas['id']) ?>">
                        <div class="row mb-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-sm-9">
                                ...
                                <a href="<?= base_url('petugas_cabang') ?>" class="btn btn-outline-secondary ms-2">
                                    Batal
                                </a>
                            </div>
                        </div>
