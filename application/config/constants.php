...
defined('STATUS_PEMBAYARAN_PENDING') or define('STATUS_PEMBAYARAN_PENDING', 'pending');
defined('STATUS_PEMBAYARAN_PAID') or define('STATUS_PEMBAYARAN_PAID', 'paid');
defined('STATUS_PEMBAYARAN_FAILED') or define('STATUS_PEMBAYARAN_FAILED', 'failed');
defined('STATUS_PEMBAYARAN_EXPIRED') or define('STATUS_PEMBAYARAN_EXPIRED', 'expired');
